...
int main(void)
{
    ...
    const GLchar* fragment_shader =
            "#version 330 core\n"
					...
					"uniform int kernelSize = 25;"
					"uniform int horizontalPass = 0;"
					...
					"	avgValue += texture2D(texture1, TexCoord.st) * incrementalGaussian.x;"
					"	coefficientSum += incrementalGaussian.x;"
					"	incrementalGaussian.xy *= incrementalGaussian.yz;"
					"	for (float i = 1.0; i <= numBlurPixelsPerSide; i++) {"
					"		avgValue += texture2D(texture1, TexCoord.st - i * texOffset * blurMultiplyVec) * incrementalGaussian.x;"
					"		avgValue += texture2D(texture1, TexCoord.st + i * texOffset * blurMultiplyVec) * incrementalGaussian.x;"
	...
	glUniform1i(glGetUniformLocation(programShader, "mode_direction"), 0);
