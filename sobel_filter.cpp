...
int main(void)
{
    ...
    const GLchar* fragment_shader =
            "#version 330 core\n"
					...
					"	horizEdge -= texture2D( texture1, vec2( TexCoord.x - x, TexCoord.y - y ) ) * 1.0;"
					"	horizEdge -= texture2D( texture1, vec2( TexCoord.x - x, TexCoord.y     ) ) * 2.0;"
					"	horizEdge -= texture2D( texture1, vec2( TexCoord.x - x, TexCoord.y + y ) ) * 1.0;"
					"	horizEdge += texture2D( texture1, vec2( TexCoord.x + x, TexCoord.y - y ) ) * 1.0;"
					"	horizEdge += texture2D( texture1, vec2( TexCoord.x + x, TexCoord.y     ) ) * 2.0;"
					"	horizEdge += texture2D( texture1, vec2( TexCoord.x + x, TexCoord.y + y ) ) * 1.0;"
					"	vec4 vertEdge = vec4( 0.0 );"
					"	vertEdge -= texture2D( texture1, vec2( TexCoord.x - x, TexCoord.y - y ) ) * 1.0;"
					"	vertEdge -= texture2D( texture1, vec2( TexCoord.x    , TexCoord.y - y ) ) * 2.0;"
					"	vertEdge -= texture2D( texture1, vec2( TexCoord.x + x, TexCoord.y - y ) ) * 1.0;"
					"	vertEdge += texture2D( texture1, vec2( TexCoord.x - x, TexCoord.y + y ) ) * 1.0;"
					"	vertEdge += texture2D( texture1, vec2( TexCoord.x    , TexCoord.y + y ) ) * 2.0;"
					"	vertEdge += texture2D( texture1, vec2( TexCoord.x + x, TexCoord.y + y ) ) * 1.0;"
					"	vec3 edge = sqrt((horizEdge.rgb * horizEdge.rgb) + (vertEdge.rgb * vertEdge.rgb));"
					"	FragColor = vec4( edge, texture2D( texture1, TexCoord ).a );"
                    "}";
