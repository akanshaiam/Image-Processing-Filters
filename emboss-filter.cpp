...
int main(void)
{
    ...
    const GLchar* fragment_shader =
            "#version 330 core\n"
                    ...
                    "void main() {"
					"	vec2 texOffset = 1.0 / vec2(float(resolution.x), float(resolution.y));"
					"	vec2 tc0 = TexCoord.st + vec2(-texOffset.s, -texOffset.t);"
					"	vec2 tc1 = TexCoord.st + vec2(0.0, 0.0-texOffset.t);"
					"	vec2 tc2 = TexCoord.st + vec2(0.0-texOffset.s,0.0);"
